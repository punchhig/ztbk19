...
x$category[grepl("CAT-4",x$category,ignore.case=TRUE)] <- 2
x$category[grepl("^IN",x$category,ignore.case=TRUE)] <- 3
x$category[grepl("^NT",x$category,ignore.case=TRUE)] <- 4
...
x$rx_outcome[grepl("^NA",x$end_rx_outcome,ignore.case=TRUE)] <- ""
x$rx_outcome[grepl("^CU",x$end_rx_outcome,ignore.case=TRUE)] <- 1
x$rx_outcome[grepl("^CO",x$end_rx_outcome,ignore.case=TRUE)] <- 2
x$rx_outcome[grepl("^F",x$end_rx_outcome,ignore.case=TRUE)] <- 3
x$rx_outcome[grepl("^D",x$end_rx_outcome,ignore.case=TRUE)] <- 4
x$rx_outcome[grepl("^L",x$end_rx_outcome,ignore.case=TRUE)] <- 5
```
